...
% computes the displacements
    ...
    max_level_y = nrOpticFlow.core.warpingDepth(eta, levels, m, m);
    max_level_x = nrOpticFlow.core.warpingDepth(eta, levels, n, n);
    ...
    for i = max(max_level_x, max_level_y):-1:min_level       
        ...
        if i == max(max_level_x, max_level_y)
            ...
            try
                tmp = nrOpticFlow.core.imregister_wrapper(double(f2_level), ...
        ...
        for j = 1:n_channels
            [ J11(:, :, j), J22(:, :, j), J33(:, :, j), ...
                J12(:, :, j), J13(:, :, j), J23(:, :, j)] = ...
                nrOpticFlow.core.get_motion_tensor_gc(...
        ...
        [du, dv] = nrOpticFlow.core.level_solver(J11, J22, J33, J12, J13, J23, weight_level, ... 
