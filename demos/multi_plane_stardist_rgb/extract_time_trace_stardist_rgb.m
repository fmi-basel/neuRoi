...
expFilePath = fullfile('/path/to/the/directory/containing/experiment_mat/',expFileName);
...
% myexp.calculatedTransformationsList = {'transf', 'transf_clahe'};
myexp.referenceTrialIdx = 12;
